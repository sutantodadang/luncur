...
func (s *server) handler() http.Handler {
	...
	mux.HandleFunc("POST /v1/projects/{project}/apps/{app}/pause", s.authed(s.handlePauseCron))
	mux.HandleFunc("POST /v1/projects/{project}/apps/{app}/resume", s.authed(s.handleResumeCron))
	mux.HandleFunc("POST /v1/projects/{project}/apps/{app}/trigger", s.authed(s.handleTriggerCron))
	mux.HandleFunc("GET /v1/projects/{project}/apps/{app}/cron-runs", s.authed(s.handleCronRuns))
	...
	mux.HandleFunc("POST /v1/projects/{project}/addons/{name}/restore", s.authed(s.handleRestoreAddon))
