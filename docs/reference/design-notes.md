...
What this documents: implementation decisions and deliberate deviations too
small for their own page — kept here as a single reference so the reasoning
isn't lost.
...
**Related:** [Build pipeline](build-pipeline.md) · [Security](security.md) · [Registry GC](../operations/registry-gc.md)
